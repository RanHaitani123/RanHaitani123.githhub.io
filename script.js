...
document.querySelector('.go-top-container').addEventListener('click', () => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        logo.addEventListener('click', function() {
            // Verifica si la sección home existe
            if (homeSection) {
                // Utiliza scrollIntoView para llevar la página al inicio del elemento con ID "home"
                homeSection.scrollIntoView({ behavior: 'smooth' });
            } else {
                // Si la sección home no existe, simplemente lleva al principio de la página
